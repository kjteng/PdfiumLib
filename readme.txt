...
Please ensure that Printer4Lazarus package is added to you project as it is REQUIRED for the components. Also, the component will not work with pdfium.dll dated on or before 2/3/2017 due to changes in the names of certain export functions. You may download the necessary dll at: https://github.com/bblanchon/pdfium-binaries/releases
